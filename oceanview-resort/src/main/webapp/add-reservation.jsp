...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
    <div class="container-fluid">
        <a class="navbar-brand" href="staff-dashboard.jsp"><i class="bi bi-building me-2"></i>Ocean View Resort</a>
        <div class="navbar-nav ms-auto">
            <span class="nav-link fw-bold text-white"><i class="bi bi-person-circle me-2"></i>${username}</span>
...
<div class="container mt-5">
    <h2 class="mb-4 text-center">Create New Reservation</h2>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="phoneNumber" 
                               value="${preSelectedGuest.phoneNumber}" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="roomTypeId" required>
                        ...
                        <c:forEach var="rt" items="${roomTypes}">
                            <option value="${rt.id}">${rt.typeName} - $${rt.ratePerNight}/night</option>
                        </c:forEach>
                    </select>
                </div>
