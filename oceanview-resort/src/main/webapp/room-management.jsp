                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" min="0.01" class="form-control" 
                               id="ratePerNight" name="ratePerNight" required>
                    </div>
                    <div class="col-md-3">
                    ...
                    <tbody>
                        <c:forEach var="rt" items="${roomTypes}">
                            <tr>
                                ...
                                <td>
                                    <a href="roomType?action=edit&id=${rt.id}" 
                                       class="btn btn-sm btn-warning">
                                        <i class="bi bi-pencil"></i> Edit
                                    </a>
                                    <a href="roomType?action=delete&id=${rt.id}" 
                                       class="btn btn-sm btn-danger"
                                       onclick="return confirm('Delete ${rt.typeName}?')">
                        ...
                        <c:if test="${empty roomTypes}">
                            <tr>
                                <td colspan="4" class="text-center py-4 text-muted">
                                    No room types found in the database.
                                </td>
                            </tr>
                        </c:if>
                    </tbody>
